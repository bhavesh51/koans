...
class AboutStrings(Koan):
    ...
    def test_use_single_quotes_to_create_string_with_double_quotes(self):
        ...
        expected_string = 'He said, "Go Away."'
        self.assertEqual(expected_string, string)

    def test_use_double_quotes_to_create_strings_with_single_quotes(self):
        string = "Don't"
        expected_string = "Don't"
        self.assertEqual(expected_string, string)
...
"""
    ...
    def test_plus_will_not_modify_original_strings(self):
        ...
        string = hi + there
        expected_hi = "Hello, "
        expected_there = "world"
        self.assertEqual(expected_hi, hi)
        self.assertEqual(expected_there, there)

    def test_plus_equals_will_append_to_end_of_string(self):
        hi = "Hello, "
        there = "world"
        hi += there
        expectec_value = "Hello, world"
        self.assertEqual(expectec_value, hi)
    ...
    def test_plus_equals_also_leaves_original_string_unmodified(self):
        ...
        self.assertEqual(expected_value, original)
